cmd_scripts/kconfig/zconf.tab.o := cc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d -Iscripts/kconfig -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -DCURSES_LOC="<ncurses.h>" -DLOCALE  -I../scripts/kconfig -Iscripts/kconfig -c -o scripts/kconfig/zconf.tab.o ../scripts/kconfig/zconf.tab.c
