cmd_tools/lib/libfdt/fdt.o := cc -Wp,-MD,tools/lib/libfdt/.fdt.o.d -Itools -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -include ../include/libfdt_env.h -idirafterinclude -idirafter../include -idirafter../arch/arm/include  -I../../lib/libfdt -I../lib/libfdt  -I../../tools -I../tools -DCONFIG_SYS_TEXT_BASE=0x1E000000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE -c -o tools/lib/libfdt/fdt.o tools/lib/libfdt/fdt.c

source_tools/lib/libfdt/fdt.o := tools/lib/libfdt/fdt.c

deps_tools/lib/libfdt/fdt.o := \
...
tools/lib/libfdt/fdt.o: $(deps_tools/lib/libfdt/fdt.o)
