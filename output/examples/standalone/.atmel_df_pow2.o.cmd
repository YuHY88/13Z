cmd_examples/standalone/atmel_df_pow2.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,examples/standalone/.atmel_df_pow2.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../examples/standalone -Iexamples/standalone -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -fno-toplevel-reorder -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(atmel_df_pow2)"  -D"KBUILD_MODNAME=KBUILD_STR(atmel_df_pow2)" -c -o examples/standalone/atmel_df_pow2.o ../examples/standalone/atmel_df_pow2.c

source_examples/standalone/atmel_df_pow2.o := ../examples/standalone/atmel_df_pow2.c

deps_examples/standalone/atmel_df_pow2.o := \
  ../include/common.h \
...
examples/standalone/atmel_df_pow2.o: $(deps_examples/standalone/atmel_df_pow2.o)
