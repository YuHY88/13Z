	...
	.file	"asm-offsets.c"
@ GNU C (Broadcom Linux 3.6) version 4.7.3 (arm-broadcom-linux-gnueabi)
...
@ -I ../arch/arm/include -I ../. -I . -D __KERNEL__ -D __UBOOT__
@ -D CONFIG_SYS_TEXT_BASE=0x1E000000 -D __ARM__ -D DO_DEPS_ONLY
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include
...
@ -Os -Wall -Wstrict-prototypes -Wno-format-security -Wno-format-nonliteral
...
.LASF58:
	.ascii	"/mnt/hgfs/ht8000-13z/uboot/u-boot-2016.01/output\000"
.LASF1:
...
.LASF38:
	.ascii	"name\000"
	.ident	"GCC: (Broadcom Linux 3.6) 4.7.3"
