cmd_arch/arm/cpu/armv7/iproc-common/genpll.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,arch/arm/cpu/armv7/iproc-common/.genpll.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../arch/arm/cpu/armv7/iproc-common -Iarch/arm/cpu/armv7/iproc-common -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(genpll)"  -D"KBUILD_MODNAME=KBUILD_STR(genpll)" -c -o arch/arm/cpu/armv7/iproc-common/genpll.o ../arch/arm/cpu/armv7/iproc-common/genpll.c

source_arch/arm/cpu/armv7/iproc-common/genpll.o := ../arch/arm/cpu/armv7/iproc-common/genpll.c

deps_arch/arm/cpu/armv7/iproc-common/genpll.o := \
    ...
    $(wildcard include/config/hurricane2/emulation.h) \
    $(wildcard include/config/iproc/emulation.h) \
    $(wildcard include/config/katana2.h) \
    $(wildcard include/config/katana2/emulation.h) \
    $(wildcard include/config/saber2.h) \
    $(wildcard include/config/iproc/pll/ref/clk.h) \
...
arch/arm/cpu/armv7/iproc-common/genpll.o: $(deps_arch/arm/cpu/armv7/iproc-common/genpll.o)
