cmd_drivers/mtd/nand/iproc_nand.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,drivers/mtd/nand/.iproc_nand.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/mtd/nand -Idrivers/mtd/nand -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(iproc_nand)"  -D"KBUILD_MODNAME=KBUILD_STR(iproc_nand)" -c -o drivers/mtd/nand/iproc_nand.o ../drivers/mtd/nand/iproc_nand.c

source_drivers/mtd/nand/iproc_nand.o := ../drivers/mtd/nand/iproc_nand.c

deps_drivers/mtd/nand/iproc_nand.o := \
    $(wildcard include/config/sys/no/flash.h) \
    $(wildcard include/config/cs1/addr.h) \
    $(wildcard include/config/cs0/addr.h) \
    $(wildcard include/config/iproc/emulation.h) \
    $(wildcard include/config/param.h) \
    $(wildcard include/config/fail.h) \
    $(wildcard include/config/iproc/spl.h) \
  ...
  ../arch/arm/include/asm/iproc-common/iproc_nand.h \
...
drivers/mtd/nand/iproc_nand.o: $(deps_drivers/mtd/nand/iproc_nand.o)
