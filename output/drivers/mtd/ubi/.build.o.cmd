cmd_drivers/mtd/ubi/build.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,drivers/mtd/ubi/.build.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/mtd/ubi -Idrivers/mtd/ubi -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(build)"  -D"KBUILD_MODNAME=KBUILD_STR(build)" -c -o drivers/mtd/ubi/build.o ../drivers/mtd/ubi/build.c
...
deps_drivers/mtd/ubi/build.o := \
    ...
    $(wildcard include/config/mtd/ubi/fastmap/autoconvert.h) \
    $(wildcard include/config/mtd/ubi/fm/debug.h) \
