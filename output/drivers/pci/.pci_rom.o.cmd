cmd_drivers/pci/pci_rom.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,drivers/pci/.pci_rom.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/pci -Idrivers/pci -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pci_rom)"  -D"KBUILD_MODNAME=KBUILD_STR(pci_rom)" -c -o drivers/pci/pci_rom.o ../drivers/pci/pci_rom.c

source_drivers/pci/pci_rom.o := ../drivers/pci/pci_rom.c

deps_drivers/pci/pci_rom.o := \
    $(wildcard include/config/always/load/oprom.h) \
    $(wildcard include/config/vga/bios/addr.h) \
    $(wildcard include/config/framebuffer/set/vesa/mode.h) \
    $(wildcard include/config/sys/isa/io/base/address.h) \
    $(wildcard include/config/framebuffer/vesa/mode.h) \
    $(wildcard include/config/x86.h) \
    $(wildcard include/config/biosemu.h) \
  ../include/common.h \
  ...
  ../include/../drivers/bios_emulator/include/x86emu/regs.h \
    $(wildcard include/config/x86emu/debug.h) \
  ../include/pci.h \
...
drivers/pci/pci_rom.o: $(deps_drivers/pci/pci_rom.o)
