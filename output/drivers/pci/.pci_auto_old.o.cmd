cmd_drivers/pci/pci_auto_old.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,drivers/pci/.pci_auto_old.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/pci -Idrivers/pci -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pci_auto_old)"  -D"KBUILD_MODNAME=KBUILD_STR(pci_auto_old)" -c -o drivers/pci/pci_auto_old.o ../drivers/pci/pci_auto_old.c

source_drivers/pci/pci_auto_old.o := ../drivers/pci/pci_auto_old.c

deps_drivers/pci/pci_auto_old.o := \
    $(wildcard include/config/sys/pci/cache/line/size.h) \
    $(wildcard include/config/pci/enum/only.h) \
    $(wildcard include/config/sys/pci/64bit.h) \
    $(wildcard include/config/dm/pci.h) \
    $(wildcard include/config/pciauto/skip/host/bridge.h) \
    $(wildcard include/config/mpc834x.h) \
    $(wildcard include/config/vme8349.h) \
  ../include/common.h \
...
drivers/pci/pci_auto_old.o: $(deps_drivers/pci/pci_auto_old.o)
