cmd_drivers/net/bcm-xgs-eth-gmac.o := /opt/arm/usr/bin/arm-linux-gcc -Wp,-MD,drivers/net/.bcm-xgs-eth-gmac.o.d  -nostdinc -isystem /opt/arm/usr/lib/gcc/arm-broadcom-linux-gnueabi/4.7.3/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/net -Idrivers/net -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x1E000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(bcm_xgs_eth_gmac)"  -D"KBUILD_MODNAME=KBUILD_STR(bcm_xgs_eth_gmac)" -c -o drivers/net/bcm-xgs-eth-gmac.o ../drivers/net/bcm-xgs-eth-gmac.c

source_drivers/net/bcm-xgs-eth-gmac.o := ../drivers/net/bcm-xgs-eth-gmac.c

deps_drivers/net/bcm-xgs-eth-gmac.o := \
    ...
    $(wildcard include/config/iproc/no/ddr.h) \
    $(wildcard include/config/l2c/as/ram.h) \
  ...
  ../drivers/net/bcm-xgs-eth.h \
    $(wildcard include/config/bcm/xgs/eth/default/port.h) \
  ../drivers/net/bcm-xgs-eth-gmac.h \
    $(wildcard include/config/addr.h) \

drivers/net/bcm-xgs-eth-gmac.o: $(deps_drivers/net/bcm-xgs-eth-gmac.o)
