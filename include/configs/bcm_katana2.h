...
//#define CONFFIG_SKIP_LOWLEVEL_INIT			1			/* compile for ram*/
...
//#define CONFIG_NAND_IPROC_BOOT						/* added by yuhy,20181217*/
...
#else
#define CONFIG_EXTRA_ENV_SETTINGS       \
	"formatubi=mtdparts delall;mtdparts default;saveenv;sf probe 0;sf erase 0x00160000 0x00a00000;ubi part kernel 1;ubi create kernel;ubi info 1\0" \
	...
	"rootfs_off=0xb60000\0"\
	"uImage_off=0x160000\0"\
	"CreateSystem=sf probe 0;sf erase $uImage_off $uImage_size;ubi part kernel 1;ubi create kernel;ubi info 1\0"\
	"dnk=tftpboot 0x61000000 uImage;sf probe 0;sf erase $uImage_off $uImage_size;sf write 0x61000000 $uImage_off $uImage_size;\0"\
	"dni=tftpboot 0x61000000 rootfs;sf probe 0;sf erase $rootfs_off $rootfs_size;sf write 0x61000000 $rootfs_off $rootfs_size;\0"\
	"clrenv=sf probe 0;sf erase 0x100000 0x60000\0" \
	"bootargs=initrd=0x62000040,0xd60000 root=/dev/ram0 console=ttyS0,115200n8 maxcpus=1 mem=480M ethaddr=00:1d:80:01:03:05\0" \
	"bootker=sf probe 0;sf read 0x61000000 $uImage_off $uImage_size;sf read 0x62000000 $rootfs_off $rootfs_size;bootm 0x61000000 0x62000000\0"	 \
	"bootcmd=run bootker\0" \
	"ethaddr=00:1d:80:01:03:05\0" \   
	"ipaddr=192.192.4.23\0" \
	"serverip=192.192.4.253\0" \
	"loadaddr=0x64000000\0" \
	"fdt_high=0xffffffff\0"
#endif
/*
...
//#define MTDIDS_DEFAULT      "nand0=nor_iproc.0"
#define MTDIDS_DEFAULT      "nand0=nand_iproc.0"
/* define default mtdpart, changed by lihz - 2018.9.11 */
//#define MTDPARTS_DEFAULT    "mtdparts=nand_iproc.0:2M(nboot),4M(nenv),10M(nsystem),48M(nrootfs),-(ncustfs)"
//#define MTDPARTS_DEFAULT    "mtdparts=nor_iproc.0:768k(uboot),64k(env),6M(kernel),9M(ramdisk),-(ncustfs)"
//#define MTDPARTS_DEFAULT    "mtdparts=nor_iproc.0:1M(uboot),384k(env),10M(kernel),4M(ramdisk),-(ncustfs)"
